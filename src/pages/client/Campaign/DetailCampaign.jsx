    ...
    <div className="main">
      ...
      <div className="container">
        <header className="header">
          <Row
            style={{ padding: "30px 24px 30px 24px", position: "relative" }}
            justify="space-between"
          >
            <Col className="flex-col-center">
              <div style={{ fontSize: 24, fontWeight: "600", marginBottom: 7 }}>
                Cuộc vận động quyên góp miền trung
              </div>
              <Row>
                <span>
            ...
            <Col className="flex-col-center">
              <Button className="btn-primary">Theo dõi cuộc vận động</Button>
            </Col>
          </Row>
        </header>
        ...
        <div className="detail-campaign-left">
          <div className="d-c-l-description">
            <Row justify={"space-between"} align={"center"}>
              <div className="name-campaign">Quyên góp miền Trung</div>
              <div>
                <Space>
            ...
            <div>
              Tinh thần “Lá lành đùm lá rách” là một đức tính cao đẹp của người
              dân Việt Nam. Trong suốt chương trình BTC đã nhận được rất nhiều
              sự ủng hộ quý báu của các MTQ đã tham gia. Xin trân trọng cảm ơn
              sâu sắc những tấm lòng đóng góp quý báu của các MTQ để BTC chúng
              tôi là nhịp cầu nối giữa các nhà hảo tâm, các mạnh thường quân,
              các tổ chức, cá nhân có lòng từ thiện cùng chia sẻ với các các đối
              tượng khuyết tật nghèo, để phần nào giúp họ có được niềm vui, sự
              ấm áp và vì một ngày mai tươi sáng hơn.
            </div>
          ...
          <div className="detail-campaign-info">
            ...
            {valueOption && valueOption === 1 && (
              <div className="detail-campaign-intro">
                <div style={{ fontWeight: 600 }}>
                  Chi tiết về cuộc vận động:
                </div>
                <div>
                  Để kịp thời chia sẻ với những khó khăn, thiệt hại to lớn của
                  đồng bào và các địa phương bị thiệt hại do mưa lũ gây ra, và
                  hưởng ứng lời kêu gọi của Chính phủ và Bộ Tài chính, Công đoàn
                  Bộ cũng đã phát động toàn thể cán bộ, công chức, viên chức,
                  người lao động ở các đơn vị thuộc và trực thuộc Bộ Tài chính
                  tham gia ủng hộ đồng bào các tỉnh miền Trung bị thiệt hại do
                  bão lũ tối thiểu 01 ngày lương.
                </div>
                <br />
                ...
                <br />
                <Button className="" type="primary" style={{ fontWeight: 600 }}>
                  Ủng hộ ngay
                </Button>
              </div>
            )}
                ...
                <div className="detail-campaign-activity">
                  <Row align={"middle"}>
                    <div style={{ fontSize: 18, fontWeight: 600 }}>
                      Bài đăng ủng hộ bão lũ miền Trung
                    </div>
                  ...
                  <div>
                    Trong thời gian vừa qua, thanh thiếu nhi và nhân dân nhiều
                    địa phương trong cả nước, đặc biệt là các tỉnh duyên hải
                    miền Trung, Tây Nguyên phải hứng chịu nhiều thiên tai gây
                    thiệt hại nặng nề về người và của, đời sống của nhân dân gặp
                    nhiều khó khăn; nhằm phát huy tinh thần “Tương thân tương
                    ái”, “Lá lành đùm lá rách” của dân tộc.{" "}
                  </div>
                  <br />
                  <Row>
                    <Space>
                      <img
                        className="detail-campaign-img"
                        src="/images/mien-trung-1.jpg"
                        alt="Image"
                      ></img>
                      <img
                        className="detail-campaign-img"
